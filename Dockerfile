# Create a container: docker create -p 4001:4001 --name demisto-web-form-react demisto-web-form-react:latest
# Start the conatiner: docker start demisto-web-form-react
# Stop the container: docker stop demisto-web-form-react
# Run a temporary container: docker run -p 4001:4001 -ti --rm demisto-web-form-react:latest
